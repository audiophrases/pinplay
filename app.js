...
const QUESTION_TYPE_EXPLANATIONS = {
  ...
  "wordle": {
    ...
    "differentiationTips": ["Author 'hints' as a gentle ramp — synonym, then category, then a near-giveaway — so struggling students can self-scaffold for a points cost while stronger students skip hints for full marks.", "Shorter words (5 letters) are easier than 8-letter ones.", "Lower maxAttempts for advanced learners.", "Set 'lexicon':'en' for English so guessing stays honest; 'none' for other languages."],
